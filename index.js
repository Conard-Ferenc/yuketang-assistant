...
// @match        127.0.0.1:5500/test.html
...
(function() {
  ...
  tip.innerHTML = `<a class="title">雨课堂助手</a><div id="content" class="content"></div><style>.tip{min-width:150px;max-width:300px;min-height:200px;position:absolute;top:100px;left:200px;background-color:aqua;-webkit-box-shadow:1px 1px 3px #292929;-moz-box-shadow:1px 1px 3px #292929;box-shadow:1px 1px 3px #292929;border-radius:10px;overflow:hidden}.title{display:block;height:30px;background-color:cornflowerblue;color:#fff;text-align:center;user-select:value;line-height:30px;cursor:grab}.content{padding:4px}.title:active{cursor:grabbing!important}</style>`;
